...
logging.basicConfig(filename='logs/solid_to_brt_topo', filemode='w',
...
process_main(args.data_path,args.output_path,method=10,dataset='mechcad',target='brt',process_num=30)